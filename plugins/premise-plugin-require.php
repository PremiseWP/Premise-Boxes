...
add_action( 'tgmpa_register', 'pboxes_require_premise_wp' );
/**
 ...
 */
function pboxes_require_premise_wp() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'pboxes',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                       // Default absolute path to bundled plugins.
		'menu'         => 'pboxes-install-plugins', // Menu slug.
