...
PremiseField.WPMedia = {
	...
	onInsert: function() {
		PremiseField.WPMedia.uploader.on('select', function() {
		    ...
		    /**
			 * premiseFieldWPMediaOnInsert
			 * 
			 * @premise-hook premiseFieldWPMediaOnInsert do hook after icons close
			 *
			 * @since  1.2
			 *
			 * @param {array} attachments selected to be inserted (multiple or one) 
			 */
			jQuery(document).trigger('premiseFieldWPMediaOnInsert', PremiseField.WPMedia.mediaUploaded );
	    });
	},
